...
// proc_read will be called when the /proc entry created by the module is called.
static ssize_t proc_read(struct file *file, char __user *usr_buf, size_t count, loff_t *pos) {
    ...
    r = snprintf(buffer, 100, "Current value of the jiffies:%d\n", jiffies);
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Create a file in /proc and display current jiffies value.");
